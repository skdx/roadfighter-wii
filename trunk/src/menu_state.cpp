		...
		case 0:
			{
                ...
                dst_blit_rect.x = 64;
				SDL_BlitSurface(tittle_sfc,0,screen,&dst_blit_rect);
		...
		case 2:
			{
				...
				if (f>=1.0) f=1.0;
				SDL_FillRect(screen,0,0);
				sge_transform(tittle_sfc,screen,0,f,f,tittle_sfc->w/2,tittle_sfc->h/2,SCREEN_X/2,tittle_sfc->h/2,0);
			}
			break;
		...
		case 3:
			{
				...
				a=(1.0F-f)*260.0F;
				SDL_FillRect(screen,0,0);
				sge_transform(tittle_sfc,screen,a,f,f,tittle_sfc->w/2,tittle_sfc->h/2,SCREEN_X/2,tittle_sfc->h/2,0);
			}
			break;
		} /* switch */ 
		break;
...
//			}
	...
	/* Credits: */ 
	{
		...
		r2.x=start_x2;
//		r2.y=174;
		r2.y=screen->h-credits_sfc->h-16; // safe area - ensure that the credits ticker is visible on TV
